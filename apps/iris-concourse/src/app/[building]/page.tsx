      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[4/3]  overflow-hidden bg-gray-100 order-2 md:order-1">
              <Image
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {building.specialFeatures.map((sf) => (
            <div
              key={sf.title}
              className="bg-black  p-8 mb-16 text-white"
            >
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-12">
            <Link
              href={`/${building.slug}/residences`}
              className="group block p-6 border border-gray-200  hover:shadow-md hover:border-gray-300 transition-all"
            >
            ...
            <Link
              ...
              className="group block p-6 border border-gray-200  hover:shadow-md hover:border-gray-300 transition-all"
            >
              <p className="text-2xl font-bold text-black mb-1">1 Bed</p>
            ...
            <Link
              ...
              className="group block p-6 border border-gray-200  hover:shadow-md hover:border-gray-300 transition-all"
            >
              <p className="text-2xl font-bold text-black mb-1">2 Bed</p>
